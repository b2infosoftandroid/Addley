...
public class RecyclerCouponAdapter_1 extends RecyclerView.Adapter<RecyclerCouponAdapter_1.OfferVH> implements RecyclerOnItemClickListener {
    private Context context;
    private List<CouponItem> data;

    public RecyclerCouponAdapter_1(Context context) {
        this.context = context;
    }

    public RecyclerCouponAdapter_1(List<CouponItem> data) {
        this.data = data;
    }

    public RecyclerCouponAdapter_1(Context context, List<CouponItem> data) {
        this.context = context;
        this.data = data;
    }
